...
/* The device who stablish the connection is the slave */
...
public class MainActivity extends Activity implements ChannelListener, DeviceActionListener {
    ...
    // Variables for managing WifiP2p
    ...
    // Server for master device and slave devices
    ...
    public void connect(WifiP2pConfig config) {
        manager.connect(channel, config, new ActionListener() {
            @Override
            public void onSuccess() {
                Log.d(MainActivity.TAG, "SLAVE >> Server Socket created!");

                // Create server for slave device
                if (slaveServer == null) {
