...

{
    ...
    protected LinkedBlockingQueue<Device> poolDevices;
    protected Context context;

    public Exe (LinkedBlockingQueue<Device> poolDevices, Context context) {
        this.context = context;
        this.poolDevices = poolDevices;
    }
...
*/
  ...
  /*}
    ...
    public void run () {
        ...
        problem.set_geneN(gn);
        problem.set_geneL(gl);
        problem.setPooledDevices(poolDevices);
